...
citadel_trooper_new_movement | sv | Default: false<br>
...
cl_parallel_readpacketentities_threshold |  | Default: 4<br>Use parallel processing of snapshot reading if above this many entries.
...
cl_particle_fallback_multiplier |  | Default: 5<br>Multiplier for falling back to cheaper effects under load.
...
cl_particle_sim_fallback_threshold_ms |  | Default: 0<br>Amount of simulation time that can elapse before new systems start falling back to cheaper versions
...
phys_threaded_cloth_bone_update | sv, cl, rep | Default: false<br>
...
street_brawl_healing_multiplier | sv, cl, rep | Default: 0.6<br>
