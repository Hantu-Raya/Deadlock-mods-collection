(() => {
  ...
  var BRIDGE_KEY = "__QolLiteShowRankWebMediaBridge";
  ...
  var SHOWRANK_WRAPPER_ACTIONS = [
    ["QolLiteShowRankTriggerProfileCard", "profile_trigger"],
    ["QolLiteShowRankOpenStatlocker", "statlocker_open"],
    [
      "QolLiteShowRankContextMenuOpenStatlocker",
      "context_menu_statlocker_open",
    ],
    ["QolLiteShowRankContextMenuOpenDeadlock", "deadlock_open"],
    ["QolLiteShowRankMarkTopBarHover", "topbar_player_hover"],
    ["QolLiteShowRankMarkPlayerListHover", "player_list_hover"],
    ["QolLiteShowRankClearPlayerListHover", "player_list_clear"],
    ["QolLiteShowRankEscapePreloadFromPlayerList", "escape_preload"],
    ["QolLiteShowRankRegisterPlayerListRowReady", "player_list_row_ready"],
  ];
  ...
  var SHOWRANK_WRAPPER_INSTALLS = [
    ["QolLiteShowRankTriggerProfileCard", "profile_trigger", "profile_card", "profile"],
    ["QolLiteShowRankOpenStatlocker", "statlocker_open", "statlocker_button", "statlocker"],
    [
      "QolLiteShowRankContextMenuOpenStatlocker",
      "context_menu_statlocker_open",
    ...
    [
      "QolLiteShowRankContextMenuOpenDeadlock",
      "deadlock_open",
      "context_menu_deadlock_button",
      "deadlock",
    ],
    ["QolLiteShowRankMarkTopBarHover", "topbar_player_hover", "topbar_hover", "topbar_hover"],
    ["QolLiteShowRankMarkPlayerListHover", "player_list_hover", "players_list_hover", "player_hover"],
    ["QolLiteShowRankClearPlayerListHover", "player_list_clear", "players_list_out", "player_clear"],
    ["QolLiteShowRankEscapePreloadFromPlayerList", "escape_preload", "escape", "escape_preload"],
    [
      "QolLiteShowRankRegisterPlayerListRowReady",
  ...
  function InstallCommonWrappers() {
    ...
    try {
      $["QolLiteShowRankOpenDeadlock"] = undefined;
    } catch (e1) {}
  }
  ...
  function PublishShowRankSharedApi() {
    ...
    try {
      ...
      bridge.api = {
        state: state,
        QolLiteInstallShowRankWrapper: InstallShowRankWrapper,
        QolLiteGuardShowRankAction: GuardShowRankAction,
        QolLiteIsPanelValid: IsPanelValid,
        QolLiteTriggerProfileCard: TriggerProfileCard,
        QolLiteSetPanelAttribute: SetPanelAttribute,
        QolLiteNowMs: NowMs,
        QolLiteIsRuntimeIdleLatched: IsRuntimeIdleLatched,
        QolLiteIsShowRankRuntimeIdleCurrent: IsShowRankRuntimeIdleCurrent,
        QolLiteRegisterTopBarPlayer: RegisterTopBarPlayer,
        QolLiteReadRegisteredTopBarCandidate: ReadRegisteredTopBarCandidate,
        QolLiteStoreManualTarget: StoreManualTarget,
        QolLiteMarkPlayerListHover: MarkPlayerListHover,
        QolLiteClearPlayerListHover: ClearPlayerListHover,
        QolLiteGetRuntimeIdleLoaded: GetRuntimeIdleLoaded,
        QolLiteEscapeAutoPopulateFromRowReady: EscapeAutoPopulateFromRowReady,
        QolLiteStartShowRankAutoloadIntent: StartShowRankAutoloadIntent,
      };
    } catch (e1) {}
  }
