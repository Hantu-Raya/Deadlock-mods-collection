...
(function () {
  ...
  var cachedRegisterPayload = "";
  var cachedBootstrapPayload = "";
  var SCHEMA = [
  ...
  function tryDirectRegister(config) {
    ...
    if (typeof root.AnitaUI.IsReady === "function" && !root.AnitaUI.IsReady())
      return false;
  ...
  function requestBootstrap(reason) {
    ...
    $.DispatchEvent("ClientUI_FireOutput", cachedBootstrapPayload);
  }
  ...
  $.RegisterForUnhandledEvent("ClientUI_FireOutput", function (payload) {
    ...
    try {
      ...
      if (data.magic_word === "ANITA_ALIVE") {
        ...
        data.magic_word === "ANITA_HANDSHAKE" &&
