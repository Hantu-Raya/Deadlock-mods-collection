...
citadel_damage_offscreen_indicator_disabled "0"             // The little trooper portraits that show up behind walls.          [def: "true"]
...
citadel_portrait_world_renderer_off         "0"          // Set true to disable hero hud
...
r_particle_max_size_cull                    "999"           // ETW CPU test: lower threshold skips culling for more large particles; uses GPU headroom.
...
anim_decode_forcewritealltransforms         "false"         // CPU test: default false; true forces BatchAnimationDecode to write transforms for all bones.
anim_disable                                "true"          
...
engine_max_ticks_to_simulate                "2"             // CPU/1% low test: cap catch-up simulation bursts. [Def: "-1"]
