...
assert(!findXmlNodeById(menuXmlTree, 'BluffDeckFeltSigil') && !xmlDescendant(bluffFelt, (node) => /\bBluffDeckFeltSigil\b/.test(node.attrs.class || '')), 'Bluff felt must remove the decorative sigil');
assert(!findXmlNodeById(menuXmlTree, 'BluffDeckStatusLabel'), 'Bluff action deck must remove the duplicate status label');
...
for (const selector of [
  '.BluffDeckCardTable', '.BluffDeckTableSeats', '.BluffDeckFelt',
...
const bluffStyleSection = menuStyle.slice(menuStyle.indexOf('.BluffDeckWindow'));
assert(!/gradient\s*\(/.test(bluffStyleSection), 'Bluff styles must use flat surfaces without gradients');
assert(!Array.from(bluffStyleSection.matchAll(/box-shadow\s*:\s*([^;]+);/g)).some((match) => match[1].trim() !== 'none'), 'Bluff styles must remove visible drop shadows');
assert(!/\.BluffDeckFeltSigil|\.BluffDeckStatusLabel/.test(menuStyle), 'menu style must remove the decorative sigil and duplicate action status selectors');
...
const bluffLobbyDeckCss = cssBlock(menuStyle, '.BluffDeckWindow.Lobby .BluffDeckActionDeck');
const bluffLobbySlotsCss = cssBlock(menuStyle, '.BluffDeckWindow.Lobby .BluffDeckCardSlots');

assertCssDeclarationMatches('menu style .BluffDeckWindow', bluffWindowCss, 'width', /^42%$/, 'must reduce the main table width by about forty percent');
assertCssDeclarationMatches('menu style .BluffDeckWindow', bluffWindowCss, 'height', /^fit-children$/, 'must size the main table to its content without dead space');
...
assertCssDeclarationMatches('menu style .BluffDeckWindow', bluffWindowCss, 'margin-left', /^21%$/, 'must center the compact table-and-ledger composition');
assertCssDeclarationMatches('menu style .BluffDeckWindow', bluffWindowCss, 'margin-top', /^12%$/, 'must use the compact Poker-like top inset');
...
assertCssDeclarationMatches('menu style .BluffDeckHistoryWindow', bluffHistoryCss, 'width', /^14%$/, 'must use the reduced archive width');
assertCssDeclarationMatches('menu style .BluffDeckHistoryWindow', bluffHistoryCss, 'height', /^56%$/, 'must use the reduced archive height');
...
assertCssDeclarationMatches('menu style .BluffDeckHistoryWindow', bluffHistoryCss, 'margin-right', /^22%$/, 'must center the compact table-and-ledger composition');
assertCssDeclarationMatches('menu style .BluffDeckHistoryWindow', bluffHistoryCss, 'margin-top', /^12%$/, 'must share the compact Poker-like top inset');
assertCssDeclarationMatches('menu style .BluffDeckHistoryWindow', bluffHistoryCss, 'padding', /^10px\s+8px$/, 'must use the reduced archive padding');
...
assert(mainEdge === 63 && historyEdge === 64 && historyEdge - mainEdge === 1, 'Bluff compact main/archive geometry must leave a 1% gap');
assertCssDeclarationMatches('menu style .BluffDeckTableSurface', bluffSurfaceCss, 'height', /^500px$/, 'must reserve the reduced table surface height around the outer seats');
...
assertCssDeclarationMatches('menu style .BluffDeckTableSurface', bluffSurfaceCss, 'padding', /^4px\s+6px$/, 'must use the reduced table surface padding');
assertCssDeclarationMatches('menu style .BluffDeckCardTable', bluffTableCss, 'width', /^100%$/, 'must fill the main table surface');
assertCssDeclarationMatches('menu style .BluffDeckCardTable', bluffTableCss, 'height', /^480px$/, 'must contain the felt and all outer seats without overlap');
assertCssDeclarationMatches('menu style .BluffDeckFelt', bluffFeltCss, 'width', /^300px$/, 'must use the reduced circular felt width');
assertCssDeclarationMatches('menu style .BluffDeckFelt', bluffFeltCss, 'height', /^300px$/, 'must use the reduced circular felt height');
assertCssDeclarationMatches('menu style .BluffDeckFelt', bluffFeltCss, 'border-radius', /^150px$/, 'must use a true reduced circular felt radius');
assertCssDeclarationMatches('menu style .BluffDeckTargetCard', bluffTargetCss, 'width', /^64px$/, 'must use the reduced target card width');
assertCssDeclarationMatches('menu style .BluffDeckTargetCard', bluffTargetCss, 'height', /^88px$/, 'must use the reduced target card height');
...
assertCssDeclarationMatches('menu style .BluffDeckCardSlots', bluffSlotsCss, 'width', /^fit-children$/, 'must keep the hand compact');
assertCssDeclarationMatches('menu style .BluffDeckCardSlots', bluffSlotsCss, 'horizontal-align', /^center$/, 'must center the hand above the actions');
assertCssDeclarationMatches('menu style .BluffDeckCardSlot', bluffSlotCss, 'width', /^44px$/, 'must use the reduced hand-card width');
assertCssDeclarationMatches('menu style .BluffDeckCardSlot', bluffSlotCss, 'height', /^64px$/, 'must use the reduced hand-card height');
assertCssDeclarationMatches('menu style .BluffDeckCardSlot', bluffSlotCss, 'margin-right', /^3px$/, 'must separate reduced hand cards without gaps');
...
assertCssDeclarationMatches('menu style .BluffDeckActionDeck', bluffActionDeckCss, 'height', /^120px$/, 'must reserve the reduced active action deck height');
assertCssDeclarationMatches('menu style .BluffDeckActionDeck', bluffActionDeckCss, 'flow-children', /^down$/, 'must stack the centered hand and action rail');
assertCssDeclarationMatches('menu style .BluffDeckActionRail', bluffActionRailCss, 'width', /^260px$/, 'must use the reduced action rail width');
assertCssDeclarationMatches('menu style .BluffDeckActionRail', bluffActionRailCss, 'horizontal-align', /^center$/, 'must center the gameplay action rail');
assertCssDeclarationMatches('menu style .BluffDeckActionControls', bluffActionControlsCss, 'width', /^100%$/, 'must fill the centered action rail');
assertCssDeclarationMatches('menu style .BluffDeckActionControls', bluffActionControlsCss, 'horizontal-align', /^center$/, 'must center the gameplay buttons');
...
assertCssDeclarationMatches('menu style .BluffDeckLifecycleControls', bluffLifecycleCss, 'height', /^40px$/, 'must keep lifecycle controls subordinate');
...
assertCssDeclarationMatches('menu style .BluffDeckTableSeats', bluffSeatsCss, 'width', /^300px$/, 'must keep Bluff seats on the reduced felt width');
assertCssDeclarationMatches('menu style .BluffDeckTableSeats', bluffSeatsCss, 'height', /^300px$/, 'must keep Bluff seats on the reduced felt height');
assertCssDeclarationMatches('menu style .BluffDeckTableSeats', bluffSeatsCss, 'align', /^center\s+center$/, 'must center the seat plane on the felt');
assertCssDeclarationMatches('menu style .BluffDeckTableSeats', bluffSeatsCss, 'ignore-parent-flow', /^true$/, 'must overlay the reduced Bluff table stage');
const bluffTopSeatCss = cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatTopLeft');
const bluffCardinalRightSeatCss = cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatTopRight');
const bluffBottomSeatCss = cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatBottomRight');
const bluffCardinalLeftSeatCss = cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatBottomLeft');
assertCssDeclarationMatches('menu style Bluff top seat', bluffTopSeatCss, 'horizontal-align', /^center$/, 'must center the top seat');
assert(Number.parseFloat(cssDeclarationValue(bluffTopSeatCss, 'margin-top')) <= -86, 'menu style Bluff top seat must sit fully outside the felt');
assertCssDeclarationMatches('menu style Bluff right seat', bluffCardinalRightSeatCss, 'vertical-align', /^center$/, 'must place the right seat at mid-table');
assert(Number.parseFloat(cssDeclarationValue(bluffCardinalRightSeatCss, 'margin-right')) <= -70, 'menu style Bluff right seat must sit fully outside the felt');
assertCssDeclarationMatches('menu style Bluff bottom seat', bluffBottomSeatCss, 'horizontal-align', /^center$/, 'must center the bottom seat');
assert(Number.parseFloat(cssDeclarationValue(bluffBottomSeatCss, 'margin-bottom')) <= -86, 'menu style Bluff bottom seat must sit fully outside the felt');
assertCssDeclarationMatches('menu style Bluff left seat', bluffCardinalLeftSeatCss, 'vertical-align', /^center$/, 'must place the left seat at mid-table');
assert(Number.parseFloat(cssDeclarationValue(bluffCardinalLeftSeatCss, 'margin-left')) <= -70, 'menu style Bluff left seat must sit fully outside the felt');
assertCssDeclarationMatches('menu style Bluff lobby action deck', bluffLobbyDeckCss, 'height', /^52px$/, 'must remove empty lobby action space');
assertCssDeclarationMatches('menu style Bluff lobby card slots', bluffLobbySlotsCss, 'visibility', /^collapse$/, 'must collapse the empty lobby hand');
assertCssDeclarationMatches('menu style Bluff lobby card slots', bluffLobbySlotsCss, 'height', /^0px$/, 'must collapse the empty lobby hand height');
...
assertMatches('menu style .BluffDeckControlButton', bluffControlButtonCss, /\bwidth\s*:\s*96px\s*;/, 'must keep lifecycle buttons compact');
