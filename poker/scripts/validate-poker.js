...
assertCssDeclarationMatches('menu style .BluffDeckTableSurface', bluffSurfaceCss, 'height', /^470px$/, 'must reserve the compact table surface height');
...
assertCssDeclarationMatches('menu style .BluffDeckTableSurface', bluffSurfaceCss, 'padding', /^6px\s+8px$/, 'must use the compact table surface padding');
assertCssDeclarationMatches('menu style .BluffDeckCardTable', bluffTableCss, 'width', /^100%$/, 'must fill the main table surface');
assertCssDeclarationMatches('menu style .BluffDeckCardTable', bluffTableCss, 'height', /^430px$/, 'must keep the compact felt stage inside the table surface');
assertCssDeclarationMatches('menu style .BluffDeckFelt', bluffFeltCss, 'width', /^400px$/, 'must use the compact circular felt width');
assertCssDeclarationMatches('menu style .BluffDeckFelt', bluffFeltCss, 'height', /^400px$/, 'must use the compact circular felt height');
assertCssDeclarationMatches('menu style .BluffDeckFelt', bluffFeltCss, 'border-radius', /^200px$/, 'must use a true compact circular felt radius');
assertCssDeclarationMatches('menu style .BluffDeckTargetCard', bluffTargetCss, 'width', /^80px$/, 'must use the compact target card width');
assertCssDeclarationMatches('menu style .BluffDeckTargetCard', bluffTargetCss, 'height', /^108px$/, 'must use the compact target card height');
...
assertCssDeclarationMatches('menu style .BluffDeckCardSlot', bluffSlotCss, 'width', /^52px$/, 'must use the compact hand-card width');
assertCssDeclarationMatches('menu style .BluffDeckCardSlot', bluffSlotCss, 'height', /^76px$/, 'must use the compact hand-card height');
assertCssDeclarationMatches('menu style .BluffDeckCardSlot', bluffSlotCss, 'margin-right', /^4px$/, 'must separate compact hand cards without gaps');
...
assertCssDeclarationMatches('menu style .BluffDeckActionDeck', bluffActionDeckCss, 'height', /^170px$/, 'must reserve the compact action deck height');
...
assertCssDeclarationMatches('menu style .BluffDeckActionRail', bluffActionRailCss, 'width', /^300px$/, 'must use the compact action rail width');
...
assertCssDeclarationMatches('menu style .BluffDeckLifecycleControls', bluffLifecycleCss, 'height', /^44px$/, 'must keep lifecycle controls subordinate');
...
assertCssDeclarationMatches('menu style .BluffDeckTableSeats', bluffSeatsCss, 'width', /^400px$/, 'must keep Bluff seats on the compact felt width');
assertCssDeclarationMatches('menu style .BluffDeckTableSeats', bluffSeatsCss, 'height', /^400px$/, 'must keep Bluff seats on the compact felt height');
...
assertCssDeclarationMatches('menu style .BluffDeckTableSeats', bluffSeatsCss, 'ignore-parent-flow', /^true$/, 'must overlay the compact Bluff table stage');
assertCssDeclarationMatches('menu style Bluff top seat', cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatTopLeft'), 'horizontal-align', /^center$/, 'must center the top seat');
assertCssDeclarationMatches('menu style Bluff right seat', cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatTopRight'), 'vertical-align', /^center$/, 'must place the right seat at mid-table');
assertCssDeclarationMatches('menu style Bluff bottom seat', cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatBottomRight'), 'horizontal-align', /^center$/, 'must center the bottom seat');
assertCssDeclarationMatches('menu style Bluff left seat', cssBlock(menuStyle, '.BluffDeckCardTable .PokerTableSeat.SeatBottomLeft'), 'vertical-align', /^center$/, 'must place the left seat at mid-table');
