...
const DEFAULT_PANEL_IDS = [
  ...
  'BluffDeckBackButton',
  'BluffDeckHeaderLabel',
  'BluffDeckAnnouncementOverlay',
  'BluffDeckAnnouncementTitle',
  'BluffDeckAnnouncementBody',
  'BluffDeckTableSurface',
  'BluffDeckTargetCard',
  'BluffDeckPlayedCards',
  'BluffDeckTargetLabel',
  'BluffDeckTurnLabel',
  'BluffDeckPreviousPlayLabel',
  'BluffDeckLifecycleControls',
  'BluffDeckPartyControls',
  'BluffDeckHostButton',
  'BluffDeckJoinButton',
  'BluffDeckLeaveButton',
  'BluffDeckMatchControls',
  'BluffDeckStartButton',
  'BluffDeckEndButton',
  'BluffDeckCardSlots',
  'BluffDeckSlot0',
  'BluffDeckSlot1',
  ...
  'BluffDeckSlot3',
  'BluffDeckSlot4',
  'BluffDeckActionLabel',
  'BluffDeckActionControls',
  'BluffDeckPlayButton',
